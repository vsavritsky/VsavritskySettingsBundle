...
namespace Vsavritsky\SettingsBundle\Form\Type;
...
class SettingValueType extends AbstractType
{
    ...
    public function buildView(FormView $view, FormInterface $form, array $options)
    {
        ...
        $view->vars = array_replace($view->vars, array(
            ...
            'expanded' => false,
            'empty_data' => null,
            'attr' => array('data-vsavritsky-settings'=>'true', 'data-sonata-select2'=>'false'),
        ...
        if ($this->htmlWidget == 'ckeditor') {
            if ($this->container->has('ivory_ck_editor.form.type')) {
                ...
                $view->vars = array_replace($view->vars, array(
                    'base_path' => $this->container->getParameter('vsavritsky_settings.ckeditor.base_path'),
                    'js_path' => $this->container->getParameter('vsavritsky_settings.ckeditor.js_path'),
                ));
            }
        }
    }
